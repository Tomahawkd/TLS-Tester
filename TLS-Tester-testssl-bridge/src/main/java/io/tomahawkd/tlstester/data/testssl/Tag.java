...
public class Tag<Result> {
	...
	static {
		...
		tagMap.put("cookie_secure", new Tag<>("cookie_secure", "Cookie secure", SectionType.HTTP_INFO, CommonParser::returnSelf));
		tagMap.put("cookie_httponly", new Tag<>("cookie_httponly", "Cookie httponly", SectionType.HTTP_INFO, CommonParser::returnSelf));
