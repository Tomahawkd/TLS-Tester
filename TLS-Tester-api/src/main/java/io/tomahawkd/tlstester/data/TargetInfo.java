 ...
 * {@link TargetInfo#analysisResult} stores test result from {@link io.tomahawkd.tlstester.analyzer.Analyzer}.
 * </p>
 *
 * <p>
 ...
 * all subclass of {@link io.tomahawkd.tlstester.analyzer.Analyzer} and eventually stores
 * analyzer tag using {@link io.tomahawkd.tlstester.analyzer.Record#column()}
...
public class TargetInfo {
	...
	/**
	 * Stores data tested from {@link io.tomahawkd.tlstester.analyzer.Analyzer}<br>
	 * Key: String tag from {@link io.tomahawkd.tlstester.analyzer.Record#column}
	 ...
	 *
	 * @param name   String tag from {@link io.tomahawkd.tlstester.analyzer.Record#column}
