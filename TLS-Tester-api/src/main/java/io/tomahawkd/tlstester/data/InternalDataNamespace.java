...
/**
 * This class contains Internal data tags collected by {@link DataCollector}<br>
 * Since the Data type could be various, the data collector returns {@link Object}, and
 * its real type has to be stored in annotation {@link DataCollectTag#type}
 */
public class InternalDataNamespace {
